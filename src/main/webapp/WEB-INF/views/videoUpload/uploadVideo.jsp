	            ...
	            <div class="row section">
	             <div class="col s12 m3 l3">
	              ...
	              <div class="input-field col s12 m3 l3">
                          <input id="videoLink" type="text" class="validate" autocomplete="off" name="videoLink" maxlength="80">
	            ...
	            <div class="row section">
	             <div class="col s12 m4 l3">
	              ...
	              <div class="input-field col s8 m4 l3">
                          <input id="title" type="text" class="validate" autocomplete="off" maxlength="80" name="title">
	             ...
	             <div class="col s12 m4 l3">
	              ...
	              <div class="input-field col s8 m4 l3">
                          <textarea id="description" type="text" class="materialize-textarea" maxlength="150" autocomplete="off" name="description" ></textarea>
