...
<jsp:include page="../fragments/header.jsp" />
	...
	<div class="section">
            ...
            <div class="row">
			<p class="col s3"><a class="waves-effect waves-light btn tooltipped modal-trigger" href="#modal1" data-position="bottom" data-delay="50" data-tooltip="Delete all Videos">Delete All Video</a>
			<p class="col s3">
			<a href="${imgvids}/user/uploadVideo" class="btn-floating btn-large waves-effect waves-light green accent-3 tooltipped"
			data-position="bottom" data-delay="50" data-tooltip="Upload a video" >
			...
			<button class="btn waves-effect waves-light blue" type="button" onclick="searchImageByDate()">Serach</button> -->
                ...
                <div id="modal1" class="modal card pink lighten-5">
                  ...
                  <h4>Delete Confirmation</h4>
                   <p>Your all video from data will be deleted permanently, and can't be undone. </p>
...
<c:when test="${ not empty allfileList}">
              ...
              <div class="masonry-gallery-wrapper">                
                <div class="popup-gallery">
                  ...
                  <div class="gallary-item"><a href="${images.videoThumbnail }" title="${images.description}" imageName="${images.videoName}" imgid=${images.id }>
                  <img src="${images.videoThumbnail }" style="padding: 2px;"></a></div>
                  </c:if>
                  </c:forEach>
			...
			<div class="col s8 m6 l6 offset-l4">
				<div class="card">
					...
					<div class="card-content">
						<p>There is no  Video.Please click upload button to upload videos.</p>
					</div>
