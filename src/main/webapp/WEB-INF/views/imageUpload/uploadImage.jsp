	            ...
	            <div class="row section">
	             <div class="col s12 m4 l3">
	              ...
	              <div class="input-field col s8 m4 l4">
                          <input id="imgLink" type="text" class="validate" autocomplete="off" name="imageLink" maxlength="80">
	            ...
	            <div class="row section">
	             <div class="col s12 m4 l3">
	              ...
	              <div class="input-field col s8 m4 l7">
                          <textarea id="imgDesc" type="text" class="materialize-textarea" maxlength="150" autocomplete="off" name="imageDescription" ></textarea>
